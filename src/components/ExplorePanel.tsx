          ...
          <ScrollView
            ...
            {activeTab === 'explore' ? (
              <View>
                ...
                {activityNotificationsForDisplay.length > 0 ? (
                  <View style={{ marginBottom: 16 }}>
                    <View
                      style={{
                        flexDirection: 'row',
                    ...
                    {activityNotificationsForDisplay.length > 6 ? (
                      <Pressable
                        onPress={() => setShowAllNotifications((prev) => !prev)}
                        style={{ alignItems: 'center', paddingVertical: 10 }}>
                        <Text style={{ color: c.accent, fontSize: 12, fontWeight: '700' }}>
                          {showAllNotifications ? 'Show less' : `See more (${activityNotificationsForDisplay.length - 6})`}
                        </Text>
                      </Pressable>
                    ) : null}
                  </View>

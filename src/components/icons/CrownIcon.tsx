...
const CROWN_XML = `<svg viewBox="0 -6 34 34" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <linearGradient x1="50%" y1="0%" x2="50%" y2="100%" id="crownGrad">
      <stop stop-color="#FFC923" offset="0%"/>
      <stop stop-color="#FFAD41" offset="100%"/>
    </linearGradient>
  </defs>
  <g transform="translate(-1463, -170)" fill="url(#crownGrad)" fill-rule="nonzero">
...
export function CrownIcon({ size = 20 }: { size?: number }) {
  return <SvgXml xml={CROWN_XML} width={size} height={size} />;
}

...
const BLOCKLIST = [
    ...
    'erotic', 'erotism', 'escort', 'eunuch', 'fag', 'faggot', 'fecal', 'felch',
    ...
    'goo girl', 'goregasm', 'grope', 'group sex', 'gspot', 'guro',
    ...
    'jailbait', 'jelly donut', 'jerk off', 'jew', 'jigaboo', 'jiggaboo',
    ...
    'nimphomania', 'nipple', 'nipples', 'nude', 'nudity', 'nympho',
    ...
    'slut', 'sm', 'smut', 'snatch', 'snowballing', 'sodomize', 'sodomy',
    ...
    'vagina', 'venus mound', 'vibrator', 'violet wand', 'vorarephilia',
    'voyeur', 'vulva', 'wank', 'wetback', 'wet dream', 'white power',
    'wrapping men', 'wrinkled starfish', 'xx', 'xxx', 'yaoi',
    'yellow showers', 'yiffy', 'zoophilia', 'nigga', 'nazi', 'kill yourself',
    'kys', 'faggot', 'dyke', 'chink', 'retard', 'spic', 'kike', 'asesinato', 'asno', 
    'bastardo', 'bollera', 'cabron', 'cabrón',
    'caca', 'chupada', 'chupapollas', 'chupeton', 'concha',
    'concha de tu madre', 'cono', 'coño', 'cofragia', 'culo',
    'drogas', 'esperma', 'fiesta de salchichas', 'follador', 'follar',
    'gilipichis', 'gilipollas', 'hacer una paja', 'haciendo el amor',
    'heroina', 'hija de puta', 'hijaputa', 'hijo de puta', 'hijoputa',
    'idiota', 'imbecil', 'infierno', 'jilipollas', 'kapullo',
    'lameculos', 'maciza', 'macizorra', 'maldito', 'mamada', 'marica',
    'maricon', 'maricón', 'mariconazo', 'martillo', 'mierda', 'nazi',
    'orina', 'pedo', 'pervertido', 'pezon', 'pinche', 'pis',
    'prostituta', 'puta', 'racista', 'ramera', 'sadico', 'semen',
    'sexo', 'sexo oral', 'soplagaitas', 'soplapollas', 'tetas grandes',
    'tia buena', 'travesti', 'trio', 'verga', 'vete a la mierda', 'vulva',
];
...
export function moderateText(text: string): { allowed: boolean; reason?: string } {
    if (!text || !text.trim()) return { allowed: true };

    const normalized = normalize(text);

    if (containsBlockedWord(normalized)) {
        return { allowed: false, reason: 'Your message contains inappropriate content and cannot be posted.' };
    }
